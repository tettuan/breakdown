...
skeleton_classification:
  ...
  distance_from_core:
    level_1: ["TwoParams", "DirectiveType", "LayerType", "ConfigProfileName"]
...
application_skeleton:
  ...
  level_1_core_domain:
    ...
    # Aggregate Root
    - name: "TwoParams"
      initializer: "create(directive: string, layer: string, profile: ConfigProfileName)"
      args: ["directive: string", "layer: string", "profile: ConfigProfileName"]
    ...
    # Value Objects
    - name: "DirectiveType"
      initializer: "create(value: string, profile?: ConfigProfileName)"
      args: ["value: string", "profile?: ConfigProfileName"]
      return: "Result<DirectiveType, DirectiveTypeError>"
      responsibility: "処理方向（what to do）: to, summary, defect"
      validation: "Pattern-based validation against ConfigProfileName patterns"
...
jsr_integration_patterns:
  ...
  config_management:
    ...
    flow: "ConfigProfileName → BreakdownConfig.create() → Pattern extraction"
...
distance_classification_rationale:
  ...
  level_1_justification:
    ...
    components: ["TwoParams", "DirectiveType", "LayerType", "ConfigProfileName"]
    distance: "0 - 骨格の中心"
