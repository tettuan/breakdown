...
削除候補:
- PromptLoader: 未使用？ BreakdownPrompt と重複
- lib/cli/prompts.ts: BreakdownPrompt を使用
- lib/cli/validators/* : 不要。BreakdownPrompt を使用
...
JSR: https://jsr.io/@tettuan/breakdownprompt を最新化
資料: https://github.com/tettuan/breakdownprompt


### 難易度

lib/cli/*.ts 多くで利用されています。
削除の難易度は高いです。
