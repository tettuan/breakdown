...
| SingleParamResult | options.ja.md | Type representing result of command with one parameter. | command |
...
| -e, --edition | [options.ja.md](./docs/breakdown/options.ja.md) | Option to specify input layer type. Sets `fromLayerType` with specified value. If not specified, uses "default". | fromLayerType, layerType |
