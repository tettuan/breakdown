...
describe("Simplified Domain Boundary Integration", () => {
  describe("Core Domain Type System Boundaries", () => {
    it("should maintain type system boundaries between DirectiveType and LayerType", () => {
  ...
  describe("Cross-Domain Interface Consistency", () => {
    ...
    it("should validate contracts between Core and Supporting domains", () => {
  ...
  describe("Integration Flow Validation", () => {
    it("should validate complete cross-domain integration flow", () => {
