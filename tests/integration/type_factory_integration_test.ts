...
import { assertEquals, assertExists, assertFalse } from "https://deno.land/std@0.210.0/assert/mod.ts";
 ...
 */
Deno.test("TypeFactory with DefaultTypePatternProvider - basic operations", () => {
 ...
 */
Deno.test("TypeFactory - provider switching", () => {
 ...
 */
Deno.test("TypeFactory - error propagation", () => {
 ...
 */
Deno.test("TypeFactory - validation performance", () => {
 ...
 */
Deno.test("TypeFactory - createBothTypes atomic operation", () => {
 ...
 */
Deno.test("TypeFactory - debug information", () => {
 ...
 */
Deno.test("TypeFactory - complex pattern support", () => {
