...
cat > "${WORK_DIR}/project-dir/project_summary.md" << 'EOL'
...
FAILED_COMMAND="breakdown to project -f ${WORK_DIR}/project-dir/project_summary.md -o ${WORK_DIR}/project-dir/project.md"
$FAILED_COMMAND || handle_error "プロジェクトへの変換に失敗しました"

# プロジェクトから課題への変換
FAILED_COMMAND="breakdown to issue -f ${WORK_DIR}/project-dir/project.md -o ${WORK_DIR}/issue-dir/issue.md"
$FAILED_COMMAND || handle_error "課題への変換に失敗しました"

# 課題からタスクへの変換
FAILED_COMMAND="breakdown to task -f ${WORK_DIR}/issue-dir/issue.md -o ${WORK_DIR}/tasks-dir/tasks.md"
$FAILED_COMMAND || handle_error "タスクへの変換に失敗しました"

echo "✓ 全ての処理が完了しました"
echo "作業ディレクトリ: ${WORK_DIR}"
echo "- プロジェクトサマリー: ${WORK_DIR}/project-dir/project_summary.md"
echo "- プロジェクト: ${WORK_DIR}/project-dir/project.md"
echo "- 課題: ${WORK_DIR}/issue-dir/issue.md"
echo "- タスク: ${WORK_DIR}/tasks-dir/tasks.md"
exit 0 