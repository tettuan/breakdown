...
describe("TypeFactory - Architectural Constraints", () => {
  ...
  it("should maintain immutability of created types", () => {
    ...
    if (result.ok) {
      ...
      assertEquals(typeof (type1 as any).setValue, "undefined");
    }
  });
  ...
  it("should enforce single responsibility through separation of concerns", () => {
    ...
    assertEquals(typeof (factory as any).getDirectivePattern, "undefined");
    assertEquals(typeof (factory as any).getLayerTypePattern, "undefined");
