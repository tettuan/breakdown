...
Deno.test("1_structure - DefaultTypePatternProvider has no responsibility duplication", () => {
  ...
  if (directivePattern && layerPattern) {
    ...
    assertExists(directivePattern.getDirectivePattern, "DirectivePattern should have getDirectivePattern method");
    assertExists(layerPattern.test, "LayerPattern should have test method");
    assertExists(layerPattern.getLayerTypePattern, "LayerPattern should have getLayerTypePattern method");
  }
