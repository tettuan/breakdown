...
describe("LayerTypeFactory - Error Structure", () => {
  ...
  it("should handle error propagation consistently", () => {
    ...
    const result = LayerTypeFactory.fromTwoParamsResult(invalidTwoParamsResult);
...
describe("LayerTypeFactory - Internal Structure", () => {
  it("should maintain proper encapsulation", () => {
    ...
    const hasSuggestionMethod = typeof (LayerTypeFactory as unknown as Record<string, unknown>).calculateSuggestions === "function";
    ...
    const hasKnownLayers = (LayerTypeFactory as unknown as Record<string, unknown>).KNOWN_LAYERS !== undefined;
