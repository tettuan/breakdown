...
describe("Architecture: Module boundary enforcement", () => {
  it("should export all public I/O interfaces from the module", async () => {
    ...
    const mod = await import("./stdin.ts");
    ...
    assertEquals(typeof mod.hasStdinContent, "function", "hasStdinContent should be a function");
    assertEquals(typeof mod.writeStdout, "function", "writeStdout should be a function");
    assertEquals(typeof mod.isStdinAvailable, "function", "isStdinAvailable should be a function");
    assertEquals(typeof mod.StdinError, "function", "StdinError should be a constructor");
    assertEquals(typeof mod.ProgressBar, "function", "ProgressBar should be a constructor");
...
describe("Architecture: Dependency direction verification", () => {
  it("should not import from higher-level modules", async () => {
    ...
    const moduleSource = await Deno.readTextFile("./lib/io/stdin.ts");
...
describe("Architecture: I/O abstraction layer compliance", () => {
  it("should provide consistent I/O interface", async () => {
    ...
    assertEquals(typeof mod.hasStdinContent, "function", "hasStdinContent should be sync function");
    assertEquals(typeof mod.writeStdout, "function", "writeStdout should be sync function");
    assertEquals(typeof mod.isStdinAvailable, "function", "isStdinAvailable should be sync function");
...
describe("Architecture: Error handling architecture", () => {
  it("should provide comprehensive error handling", async () => {
    ...
    const error = new mod.StdinError("test error");
  ...
  it("should handle async operation failures gracefully", async () => {
    ...
    const result = mod.readStdin({ timeout: 1 }); // Very short timeout
    ...
    try {
      ...
      assertEquals(error instanceof mod.StdinError, true, "Should throw StdinError");
    }
...
describe("Architecture: Performance and resource management", () => {
  it("should provide efficient I/O operations", async () => {
    ...
    const isAvailable = mod.isStdinAvailable();
  ...
  it("should manage UI component resources properly", async () => {
    ...
    const progressBar = new mod.ProgressBar(100, 40, { quiet: true });
    ...
    const spinner = new mod.Spinner({ quiet: true });
...
describe("Architecture: Integration layer compliance", () => {
  ...
  it("should support timeout management integration", async () => {
    ...
    const readStdinFn = mod.readStdin.toString();
...
describe("Architecture: Module cohesion and coupling", () => {
  it("should have high cohesion within I/O module", async () => {
    ...
    for (const exportName of exportNames) {
      ...
      const isIORelated = 
        typeof exportValue === "function" ||  // Functions and constructors
