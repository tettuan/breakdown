...
Deno.test("0_architecture - AsyncConfigPatternProvider instance methods have correct signatures", () => {
...
Deno.test("0_architecture - TypePatternProvider interface consistency", () => {
  ...
  for (const method of methods) {
    assertExists((defaultProvider as unknown as Record<string, unknown>)[method]);
    assertEquals(
      typeof (defaultProvider as unknown as Record<string, unknown>)[method],
      "function",
    );
  }
