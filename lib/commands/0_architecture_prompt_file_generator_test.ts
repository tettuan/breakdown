...
describe("Architecture: PromptFileGenerator Class Structure", () => {
  it("should export required public interfaces", () => {
    ...
    assertEquals(
      typeof PromptFileGenerator,
      "function",
      "PromptFileGenerator must be a class constructor",
    );
    ...
    assertExists(
      PromptFileErrorType.PromptFileNotFound,
      "PromptFileNotFound error type must exist",
    );
