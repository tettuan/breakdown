...
describe("PromptTemplatePathResolver - Class Structure", () => {
  it("should have a clear single responsibility for template path resolution", async () => {
    ...
    assertEquals(typeof (resolver as any).readTemplate, "undefined");
    assertEquals(typeof (resolver as any).processTemplate, "undefined");
    assertEquals(typeof (resolver as any).renderTemplate, "undefined");
  ...
  it("should properly encapsulate internal logic", async () => {
    ...
    assertEquals(typeof (resolver as any).getPromptDir, "undefined");
    assertEquals(typeof (resolver as any).getSchemaDir, "undefined");
    assertEquals(typeof (resolver as any).buildTemplatePath, "undefined");
    assertEquals(typeof (resolver as any).getTemplateFilename, "undefined");
  ...
  it("should maintain immutable state after construction", async () => {
    ...
    (params as any).layerType = "modified";
...
describe("PromptTemplatePathResolver - Abstraction Levels", () => {
  ...
  it("should handle configuration-based directory resolution", async () => {
    ...
    const configs = [
      ...
      { app_prompt: { base_dir: "/absolute/prompts" }, app_schema: { base_dir: "/absolute/schemas" } }
    ];
...
describe("PromptTemplatePathResolver - Edge Cases and Boundaries", () => {
  it("should handle missing configuration gracefully", async () => {
    ...
    edgeConfigs.forEach((config, index) => {
      const resolver = new PromptTemplatePathResolver(config as any, params);
  ...
  it("should provide meaningful error information for invalid configurations", async () => {
    ...
    const resolver = new PromptTemplatePathResolver(invalidConfig as any, params);
