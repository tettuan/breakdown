...
Deno.test("0_architecture: Totality pattern - exhaustive parameter validation", () => {
  ...
  const invalidLegacyResult = InputFilePathResolver.create(validConfig, invalidLegacy as any);
  ...
  const invalidTotalityResult = InputFilePathResolver.create(validConfig, invalidTotality as any);
