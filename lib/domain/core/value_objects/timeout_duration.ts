 ...
 */
export function isNonIntegerValueError(error: TimeoutDurationError): error is Extract<TimeoutDurationError, { kind: "NonIntegerValue" }> {
  return error.kind === "NonIntegerValue";
}

export function isBelowMinimumError(error: TimeoutDurationError): error is Extract<TimeoutDurationError, { kind: "BelowMinimum" }> {
  return error.kind === "BelowMinimum";
}

export function isAboveMaximumError(error: TimeoutDurationError): error is Extract<TimeoutDurationError, { kind: "AboveMaximum" }> {
  return error.kind === "AboveMaximum";
}

export function isInvalidSecondsError(error: TimeoutDurationError): error is Extract<TimeoutDurationError, { kind: "InvalidSeconds" }> {
  return error.kind === "InvalidSeconds";
}

export function isInvalidMinutesError(error: TimeoutDurationError): error is Extract<TimeoutDurationError, { kind: "InvalidMinutes" }> {
  return error.kind === "InvalidMinutes";
}

export function isInvalidScaleFactorError(error: TimeoutDurationError): error is Extract<TimeoutDurationError, { kind: "InvalidScaleFactor" }> {
  return error.kind === "InvalidScaleFactor";
}

export function isNullOrUndefinedError(error: TimeoutDurationError): error is Extract<TimeoutDurationError, { kind: "NullOrUndefined" }> {
  return error.kind === "NullOrUndefined";
}

export function isInvalidTypeError(error: TimeoutDurationError): error is Extract<TimeoutDurationError, { kind: "InvalidType" }> {
