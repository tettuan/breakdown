...
Deno.test("0_architecture: Result type pattern - no exceptions thrown", () => {
  ...
  testCases.forEach((input: any) => {
    ...
    try {
      result = ConfigSetName.create(input);
...
Deno.test("0_architecture: Type guards - correct discrimination for each error type", () => {
  ...
  const testCases: Array<{
  ...
  }> = [
    {
      ...
      otherGuards: [isInvalidFormatError, isReservedNameError, isTooLongError, isInvalidCharactersError, isStartsWithReservedPrefixError],
    },
    {
      input: 123,
      expectedGuard: isInvalidFormatError,
      otherGuards: [isEmptyNameError, isReservedNameError, isTooLongError, isInvalidCharactersError, isStartsWithReservedPrefixError],
    },
    {
      input: "default",
      expectedGuard: isReservedNameError,
      otherGuards: [isEmptyNameError, isInvalidFormatError, isTooLongError, isInvalidCharactersError, isStartsWithReservedPrefixError],
    },
    {
      input: "a".repeat(70),
      expectedGuard: isTooLongError,
      otherGuards: [isEmptyNameError, isInvalidFormatError, isReservedNameError, isInvalidCharactersError, isStartsWithReservedPrefixError],
    },
    {
      input: "invalid@char",
      expectedGuard: isInvalidCharactersError,
      otherGuards: [isEmptyNameError, isInvalidFormatError, isReservedNameError, isTooLongError, isStartsWithReservedPrefixError],
    },
    {
      input: "sys-config",
      expectedGuard: isStartsWithReservedPrefixError,
      otherGuards: [isEmptyNameError, isInvalidFormatError, isReservedNameError, isTooLongError, isInvalidCharactersError],
    },
  ];
