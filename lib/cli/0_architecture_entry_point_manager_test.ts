...
Deno.test("Entry Point Manager Architecture - Factory methods follow naming conventions", () => {
  ...
  for (const methodName of factoryMethods) {
    const method = (EntryPointManager as unknown as Record<string, unknown>)[methodName];
...
Deno.test("Entry Point Manager Architecture - Manager implements proper encapsulation", () => {
  ...
  assertEquals(
    (manager as unknown as Record<string, unknown>).createStandard,
    undefined,
    "Factory methods should not be instance methods",
  );
  assertEquals(
    (manager as unknown as Record<string, unknown>).createDevelopment,
    undefined,
    "Factory methods should not be instance methods",
  );
  assertEquals(
    (manager as unknown as Record<string, unknown>).createProduction,
    undefined,
    "Factory methods should not be instance methods",
  );
