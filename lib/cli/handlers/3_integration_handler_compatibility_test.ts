    ...
    try {
      switch (component) {
        ...
        case "TwoParamsPromptGenerator":
          ...
          results[component] = true;
          break;
        case "TwoParamsOutputWriter":
          await import("../writers/two_params_output_writer.ts");
          results[component] = true;
          break;
      }
    } catch (error) {
      results[component] = false;
      console.log(`Component ${component} not available:`, error.message);
    }
  }
