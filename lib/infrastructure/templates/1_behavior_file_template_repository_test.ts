...
Deno.test("FileTemplateRepository loadTemplate - successful load with caching", async () => {
  ...
  try {
    ...
    await createTestTemplateFile(tempDir, "to", "project", "test.md", templateContent);
...
Deno.test("FileTemplateRepository exists - accurate existence check", async () => {
  ...
  try {
    // Create test template file
    await createTestTemplateFile(tempDir, "summary", "task", "exists.md", "Content");
...
Deno.test("FileTemplateRepository listAvailable - returns manifest with all templates", async () => {
  ...
  try {
    ...
    await createTestTemplateFile(tempDir, "to", "project", "convert.md", "Convert content");
    await createTestTemplateFile(tempDir, "to", "task", "transform.md", "Transform content");
    await createTestTemplateFile(tempDir, "summary", "project", "summarize.md", "Summary content");
...
Deno.test("FileTemplateRepository listAvailable - filters by directive", async () => {
  ...
  try {
    ...
    await createTestTemplateFile(tempDir, "to", "project", "convert.md", "Convert");
    await createTestTemplateFile(tempDir, "summary", "project", "summarize.md", "Summary");
...
Deno.test("FileTemplateRepository delete - removes existing template", async () => {
  ...
  try {
    ...
    await createTestTemplateFile(tempDir, "to", "project", "todelete.md", "Content to delete");
...
Deno.test("FileTemplateRepository refresh - clears cache and manifest", async () => {
  ...
  try {
    ...
    await createTestTemplateFile(tempDir, "to", "project", "cached.md", "Cached content");
    ...
    await createTestTemplateFile(tempDir, "summary", "task", "new.md", "New content");
