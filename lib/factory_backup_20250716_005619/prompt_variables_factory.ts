...
import { formatSchemaError as _formatSchemaError } from "./schema_file_path_resolver_totality.ts";
...
function createTwoParamsResult(
  ...
  // Use createWholeTwoParamsResult for Totality compliance
  return createWholeTwoParamsResult(baseTwoParams);
}
