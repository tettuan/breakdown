 ...
 * - This library only handles file path resolution for schema, not their content
 ...
 *
 * This file is auto-generated from the assets/schema directory.
 * Do not edit this file directly.
 */
...
`;
  ...
  for await (const entry of Deno.readDir(SCHEMAS_DIR)) {
    if (entry.isDirectory) {
      ...
      const hasSchema = Array.from(Deno.readDirSync(commandDir)).some((e) => e.isDirectory);
